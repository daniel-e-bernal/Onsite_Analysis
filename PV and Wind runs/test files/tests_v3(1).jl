...
electric_load_folder_path = "/projects/iedo00onsite/data/facility_load_profiles/"
...
function tech_potential_reopt(;
    ...
    input_data = JSON.parsefile("/projects/iedo00onsite/inputs/$data_file")
    ...
    for i in sites_iter
        ...
        println("Completed run number $i")
    ...
    write.("/projects/iedo00onsite/results/PV_results_$batch_number.json", JSON.json(analysis_runs))
    println("Successfully printed results on JSON file")
    #write inputs onto JSON file
    write.("/projects/iedo00onsite/results/inputs_PV_onsite_analysis_$batch_number.json", JSON.json(input_data_dic))
    println("Successfully printed data site inputs onto JSON dictionary file")
    #write inputs onto JSON file
    write.("/projects/iedo00onsite/results/inputs_REopt_$batch_number.json", JSON.json(input_REopt_dic))
    ...
    inputs_file = "inputs_REopt_$batch_number.json"
    inputs_all = JSON.parsefile("/projects/iedo00onsite/results/$inputs_file")
    println("Successfuly parsed $inputs_file from JSON file")

    inputs_file2 = "inputs_PV_onsite_analysis_$batch_number.json"
    input_data_dic = JSON.parsefile("/projects/iedo00onsite/results/$inputs_file2")
    ...
    df = DataFrame(
        ...
        #estimated_electric_load_or_real = (analysis_runs[sites_iter, :estimated_electric_load_or_real]),
        input_annual_ng_load_mmbtu = (analysis_runs[sites_iter, :ng_annual_consumption]),
        #estimated_ng_load_or_real = (analysis_runs[sites_iter, :estimated_ng_load_or_real]),
        #ground PV inputs
        ...
        #AER minus SRMER
        BAU_Total_Annual_Emissions_lbs_CO2e_aer_gen_site = (round.(emissions[sites_iter, :BAU_emissions_aer_gen_co2e_c_wo_tech_w_ng], digits=4)),
        emissions_srmer_delta_lbs_CO2e_w_tech = (round.(emissions[sites_iter, :emissions_srmer_from_tech], digits=4)),
        Total_Annual_Emissions_lbs_CO2_aer_gen_minus_srmer_w_tech_site = (round.(emissions[sites_iter, :RESULT_bau_emissions_aer_minus_srmer_emissions_w_tech_w_ng], digits=4)),
        Emission_Reduction_Fraction_aer_srmer_site = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_aer_srmer_emissions_w_tech_w_ng], digits=2)),
        BAU_Total_Annual_Emissions_lbs_CO2e_aer_gen_elec_only = (round.(emissions[sites_iter, :BAU_emissions_aer_gen_co2e_c_wo_tech_no_ng], digits=4)),
        Total_Annual_Emissions_lbs_CO2_aer_gen_minus_srmer_w_tech_elec_only = (round.(emissions[sites_iter, :RESULT_bau_emissions_aer_minus_srmer_emissions_w_tech_no_ng], digits=4)),
        Emission_Reduction_Fraction_aer_srmer_elec_only = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_aer_srmer_emissions_w_tech_no_ng], digits=2)),
        #AER 
        Emission_Reduction_Fraction_aer_aer_site = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_aer_aer_emissions_w_tech_w_ng], digits=2)),
        Total_Annual_Emissions_lbs_CO2_aer_gen_w_tech_elec_only = (round.(emissions[sites_iter, :RESULT_BAU_emissions_aer_minus_aer_emissions_w_tech_no_ng], digits=4)),
        Emission_Reduction_Fraction_aer_aer_elec_only = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_aer_aer_emissions_w_tech_no_ng], digits=2)),
        #SRMER
        BAU_Total_Annual_Emissions_lbs_CO2e_srmer_site = (round.(emissions[sites_iter, :BAU_emissions_srmer_co2e_wo_tech_w_ng], digits=4)),
        Emission_Reduction_Fraction_srmer_srmer_site = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_srmer_srmer_emissions_w_tech_w_ng], digits=2)),
        BAU_Total_annual_emissions_lbs_CO2e_srmer_elec_only = (round.(emissions[sites_iter, :BAU_emissions_srmer_co2e_wo_tech_no_ng], digits=4)),
        Total_Annual_Emissions_lbs_CO2_srmer_w_tech_site = (round.(emissions[sites_iter, :RESULT_bau_emissions_srmer_minus_srmer_emissions_w_tech_no_ng], digits=4)),
        Emission_reduction_fraction_srmer_srmer_elec_only = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_srmer_srmer_emissions_w_tech_no_ng], digits=4)),
        #LRMER 
        BAU_Total_Annual_Emissions_lbs_CO2e_lrmer_site = (round.(emissions[sites_iter, :BAU_emissions_lrmer_co2e_wo_tech_w_ng], digits=4)),
        Emission_Reduction_Fraction_lrmer_lrmer_site = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_lrmer_lrmer_emissions_w_tech_w_ng], digits=2)),
        BAU_Total_annual_emissions_lbs_CO2e_lrmer_elec_only = (round.(emissions[sites_iter, :BAU_emissions_lrmer_co2e_wo_tech_no_ng], digits=4)),
        Total_Annual_Emissions_lbs_CO2_lrmer_w_tech_elec_only = (round.(emissions[sites_iter, :RESULT_bau_emissions_lrmer_minus_lrmer_emissions_w_tech_no_ng], digits=4)),
        Emission_reduction_fraction_lrmer_lrmer_elec_only = (round.(emissions[sites_iter, :PERCENT_CHANGE_from_bau_emissions_lrmer_lrmer_emissions_w_tech_no_ng], digits=4))
    )
    println(df)

    # Define path to csv file
    file_storage_location = "/projects/iedo00onsite/results/run_result_batch_num_$batch_number.csv"
