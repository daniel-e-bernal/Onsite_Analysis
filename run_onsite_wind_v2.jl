...
@everywhere begin
    ...
    function run_site(i::Int)
        ...
        if ismissing(turbine_step)
            ...
            if counter == 0
                file_storage_location = joinpath("C:/Users/dbernal/Documents/GitHub/Onsite_Analysis/results/Wind/results_turbine_0/", "$(file_name)_run_result.csv")
            elseif counter == 1
                file_storage_location = joinpath("C:/Users/dbernal/Documents/GitHub/Onsite_Analysis/results/Wind/results_turbine_1/", "$(file_name)_run_result.csv")
            elseif counter == 2
                file_storage_location = joinpath("C:/Users/dbernal/Documents/GitHub/Onsite_Analysis/results/Wind/results_turbine_2/", "$(file_name)_run_result.csv")
            elseif counter == 3
                file_storage_location = joinpath("C:/Users/dbernal/Documents/GitHub/Onsite_Analysis/results/Wind/results_turbine_3/", "$(file_name)_run_result.csv")
            elseif counter == 4
                file_storage_location = joinpath("C:/Users/dbernal/Documents/GitHub/Onsite_Analysis/results/Wind/results_turbine_4/", "$(file_name)_run_result.csv")
            else
...
evaluated = readdir("C:/Users/dbernal/Documents/GitHub/Onsite_Analysis/results/Wind/results_turbine_0/")
