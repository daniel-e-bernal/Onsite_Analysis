...
@everywhere begin
    ...
    function select_wind_turbines(row::DataFrame, max_load::Real, cap_factor::Real, inputs::Dict)
    ...
    wind_resource_path = "C:/GitRepos/Onsite_Energy_temporary/wind_resource_data/"
    ...
    function run_site(i::Int)
        ...
        file_storage_location = joinpath("C:/GitRepos/Onsite_Energy_temporary/results/Wind/results/", "$(file_name)_run_result.csv")
...
evaluated = readdir("C:/GitRepos/Onsite_Energy_temporary/results/Wind/results/")
