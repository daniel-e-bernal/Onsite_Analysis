...
function tech_potential_reopt(;
    ...
    write.("./results/PV_results_$batch_number.json", JSON.json(analysis_runs))
    println("Successfully printed results on JSON file")
    #write inputs onto JSON file
    write.("./results/inputs_PV_onsite_analysis_$batch_number.json", JSON.json(input_data_dic))
    println("Successfully printed data site inputs onto JSON dictionary file")
    #write inputs onto JSON file
    write.("./results/inputs_REopt_$batch_number.json", JSON.json(input_REopt_dic))
